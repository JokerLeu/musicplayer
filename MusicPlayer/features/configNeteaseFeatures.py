...
class ConfigNetEase(QObject):
    ...
    def __init__(self, parent=None):
        super(ConfigNetEase, self).__init__()  # 初始化，QT实例
        self.netEase = parent
    ...
    def initThread(self):
        # 一个线程，初始化用于请求歌单的全部内容。
        self.netThread = RequestThread(self, self.getSings)  # 实例化网络请求线程类（请求歌单）
    ...
    def threadSetSings(self):
        ...
        for i in range(30):
            ...
            frame = OneSing(self.gridRow, self.gridColumn, self.playlistIds[i], self, picName)  # 框架，一首歌
